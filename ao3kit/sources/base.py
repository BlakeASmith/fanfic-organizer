...
JSONL remains the interchange format across AO3, Wikipedia, and future
sources. Records always carry ``work_id`` + ``url`` (required by the Calibre
...
KNOWN_SOURCES = frozenset({SOURCE_AO3, SOURCE_WIKIPEDIA})
