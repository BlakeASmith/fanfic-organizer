...
- **Fill from AO3** — identify selected books from a work URL, the EPUB, or title + author (picker when several works match), then fill missing metadata and EPUBs as each work page lands ([demo](demos/README.md))
