...
- Add **Open in AO3** as a top-level library right-click action (and on the Fanfic Organizer toolbar menu) to open selected books on archiveofourown.org from their `ao3` / `url` identifiers.
